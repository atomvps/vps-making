...
TOKEN = os.getenv('TOKEN', '8714197930:AAFh0CIU7vRuODk51hMNRSW4ooYIcPp7yYQ')
OWNER_ID = int(os.getenv('OWNER_ID',  7210827441))
ADMIN_ID = int(os.getenv('ADMIN_ID', 7210827441))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', '@HeR_HoLiC18')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', '@HeR_HoLiC_18')
